    ...
    return (
        <div className="relative h-full w-full flex flex-col lg:flex-row lg:justify-between items-center lg:items-start p-10 z-10">
            ...
            <div className="relative lg:min-h-[650px] w-full max-w-[275px] items-center flex flex-col justify-start mx-10 mt-20 mb-8 lg:mb-0">
                <div className="flex flex-col items-center">
                    <Image
                        ...
                        height={200}
                    />
                    <h2 className="mono-label text-lg font-semibold mt-4">ECOSOC</h2>
                </div>
                <div className="mt-5 mb-5 lg:mt-20 text-center md:text-left">
                    ...
                    <p>
                    Topic 1:<br /> Strengthening Global Partnerships and Financing for Achieving the 2030 Sustainable Development Goals. <br /><br />
                    Topic 2:<br /> Climate Resilience and Green Innovation: Accelerating Action for a Sustainable Future.
                    </p>
                </div>
            </div>
            <div className="w-full h-full items-center px-4 flex flex-col justify-center mb-8 lg:mb-0">
                ...
                <iframe src="https://drive.google.com/file/d/1_yA31113OcrO8sxcGYiXu5KNsaxg5SmE/preview" className="w-full min-w-[300px] max-w-[500px] h-full min-h-[700px]" />

                <div className="flex justify-center text-center mt-10">
                    <a href="/his-global-conclave-edition-2/bg-guide/ECOSOC-BG-V3.pdf" download>
                    <HoverBorderGradient
            ...
            <div className="min-h-[650px] w-full max-w-[200px] items-center flex flex-col justify-between mx-10">
                <h2 className="mono-label text-lg font-semibold mb-8">Executive Board</h2>
                    <ExpandableCard
                        name="M Sivakeerthana"
                        title="Chairperson"
                        description="Chairperson: ECOSOC"
                        src="/his-global-conclave-edition-2/images/team_members/ecosoc-chair.webp"
                    />
                    <ExpandableCard
                        name="Bhuvanaesh R"
                        title="Vice-Chairperson"
                        description="Vice-Chairperson: ECOSOC"
                        src="/his-global-conclave-edition-2/images/team_members/ecosoc-vice-chair-p1.webp"
                    />
                    <ExpandableCard
                        name="Akshaya Nidhi OG"
                        title="Vice-Chairperson"
                        description="Vice-Chairperson: ECOSOC"
                        src="/his-global-conclave-edition-2/images/team_members/ecosoc-vice-chair-p2.webp"
                    />
            </div>
        </div>
    );
